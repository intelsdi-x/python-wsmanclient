...
class NICManagement(object):
    ...
    def _parse_drac_nic_interfaces(self, drac_nic_interface):
        return NICInterface(
            ...
            product_name=self._get_nic_interface_attr(drac_nic_interface, 'ProductName'),
            mac_address=self._get_nic_interface_attr(drac_nic_interface, 'PermanentMACAddress'),
            linkspeed=self._get_nic_interface_attr(drac_nic_interface, 'LinkSpeed')
            )
